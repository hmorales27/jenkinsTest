...
public enum Device {
    ...
    public init() {
        ...
        func mapIdentifierToDevice(identifier: String) -> Device {
                ...
                case "iPad6,3":                                 return iPadBabyPro
    ...
    public static var allPads: [Device] {
        return [.iPad2, .iPad3, .iPad4, .iPadAir, .iPadAir2, .iPadMini, .iPadMini2, .iPadMini3, .iPadMini4, .iPadBabyPro, .iPadPro]
    }
...
extension Device: CustomStringConvertible {
    ...
    public var description: String {
            ...
            case .iPadBabyPro:                  return "iPad Baby Pro"
